...
aoi_poly <- read_sf('D:/ROBO/projects/TX_FortWorth_Dallas/aois/aoi1.geojson')
aerial_path <- 'D:/ROBO/projects/TX_FortWorth_Dallas/naip_20201010_for_aoi1.tif'
sat_paths <- c('D:/ROBO/S2/FortWorth/L2A_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_T14SPB_A027708_20201011T171836_B04.tif',
               'D:/ROBO/S2/FortWorth/L2A_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_T14SPB_A027708_20201011T171836_B03.tif', 
               'D:/ROBO/S2/FortWorth/L2A_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_T14SPB_A027708_20201011T171836_B02.tif')
c_region_size <- 30 * 10 
grid_lindim_length <- 30 * 10
out_name <- 'D:/ROBO/projects/TX_FortWorth_Dallas/aoi1_with_border'
ahm(aoi_poly=aoi_poly, aerial_path=aerial_path, sat_paths=sat_paths,
    c_region_size=c_region_size, grid_lindim_length=grid_lindim_length, out_name=out_name)

#---------prev as of 9/25/22---------
#TX_Fort_Worth/TX_Dallas project
aoi_poly <- read_sf('D:/ROBO/projects/TX_FortWorth_Dallas/aois/aoi1.geojson')
aerial_path <- 'D:/ROBO/projects/TX_FortWorth_Dallas/naip_20201010_for_aoi1.tif'
sat_paths <- c('D:/ROBO/S2/FortWorth/L2A_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_T14SPB_A027708_20201011T171836_B04.tif',
               'D:/ROBO/S2/FortWorth/L2A_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_T14SPB_A027708_20201011T171836_B03.tif', 
...
c_region_size <- 30 * 10 
grid_lindim_length <- 30 * 10
out_name <- 'D:/ROBO/projects/TX_FortWorth_Dallas/aoi1'
ahm(aoi_poly=aoi_poly, aerial_path=aerial_path, sat_paths=sat_paths,
    c_region_size=c_region_size, grid_lindim_length=grid_lindim_length, out_name=out_name)

#try again with TOA
sat_paths <- c('D:/ROBO/S2/FortWorth/L1C_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_L1C_T14SPB_A027708_20201011T171836_B04.tif',
               'D:/ROBO/S2/FortWorth/L1C_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_L1C_T14SPB_A027708_20201011T171836_B03.tif', 
               'D:/ROBO/S2/FortWorth/L1C_T14SPB_A027708_20201011T171836_2020-10-11_con/RT_L1C_T14SPB_A027708_20201011T171836_B02.tif')
out_name <- 'D:/ROBO/projects/TX_FortWorth_Dallas/aoi1_toa'
ahm(aoi_poly=aoi_poly, aerial_path=aerial_path, sat_paths=sat_paths,
    c_region_size=c_region_size, grid_lindim_length=grid_lindim_length, out_name=out_name)

#TOA wasn't any better, 
#try again with added noise
out_name <- 'D:/ROBO/projects/TX_FortWorth_Dallas/aoi1_with_aerial_noise'
added_aerial_noise <- 2.0 
ahm(aoi_poly=aoi_poly, aerial_path=aerial_path, sat_paths=sat_paths,
    c_region_size=c_region_size, grid_lindim_length=grid_lindim_length, out_name=out_name,
    added_aerial_noise = added_aerial_noise)

#oise wasn't the issue, there was a typo
out_name <- 'D:/ROBO/projects/TX_FortWorth_Dallas/aoi1_fixed_green'
added_aerial_noise <- 0
ahm(aoi_poly=aoi_poly, aerial_path=aerial_path, sat_paths=sat_paths,
    c_region_size=c_region_size, grid_lindim_length=grid_lindim_length, out_name=out_name,
    added_aerial_noise = added_aerial_noise)

#------prev-------------
aoi_poly <- read_sf('D:/ROBO/tests/aoi_poly.geojson')
aerial_path <- 'D:/ROBO/tests/aerial_2010_bigger_aoi.tif'
sat_paths <- c("D:/ROBO/LS/033029/sr/LT05_L2SP_033029_20100716_20200824_02_T1_SR_B3.TIF", "D:/ROBO/LS/033029/sr/LT05_L2SP_033029_20100716_20200824_02_T1_SR_B2.TIF", "D:/ROBO/LS/033029/sr/LT05_L2SP_033029_20100716_20200824_02_T1_SR_B1.TIF")
c_region_size <- 30 * 10 
grid_lindim_length <- 30 * 10
out_name <- 'D:/ROBO/tests/matching'

#terra::distance crash testing
legitness_points <- read_sf('D:/ROBO/tests/legitness_points_for_distance.geojson')
legit_point <- legitness_points[legitness_points$legit=='legit',]
illegitimate_point <- legitness_points[legitness_points$legit!='legit',]

#reprex from last year's bug report
crs <- "+proj=utm +zone=1 +datum=WGS84"
r <- rast(ncol = 20, nrow = 20, xmin = 20, xmax = 40, ymin = 20, ymax = 40, crs=crs)
...
aerial_raster <- raster::raster(aerial_interp_cropped)
neighbor_center_sp <- as_Spatial(neighbor_center)
more_distance <- raster::distanceFromPoints(aerial_raster, neighbor_center_sp)
